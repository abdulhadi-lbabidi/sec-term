        ...
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-primary">1.</span> {t('privacy.sections.sec1_title')}
            </h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-primary">2.</span> {t('privacy.sections.sec2_title')}
            </h2>
            <p className="text-gray-600 leading-relaxed text-lg">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-primary">3.</span> {t('privacy.sections.sec3_title')}
            </h2>
            <p className="text-gray-600 leading-relaxed text-lg">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-primary">4.</span> {t('privacy.sections.sec4_title')}
            </h2>
            <p className="text-gray-600 leading-relaxed text-lg">
