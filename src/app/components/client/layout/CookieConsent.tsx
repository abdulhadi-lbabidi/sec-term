...
export const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] p-4 md:p-6 bg-background/95 backdrop-blur-md border-t border-border shadow-[0_-5px_15px_-10px_rgba(0,0,0,0.1)] animate-in slide-in-from-bottom-5 duration-500">
