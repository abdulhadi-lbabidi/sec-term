      ...
      <div className="bg-primary/5 border border-primary/10 rounded-[3rem] p-8 md:p-12 lg:p-16 max-w-7xl mx-auto flex flex-col shadow-sm">
        ...
        <div className="flex flex-col xl:flex-row justify-between items-center pt-8 border-t border-primary/10 gap-6">
          <div className="flex flex-col md:flex-row items-center gap-6 text-sm text-muted-foreground font-medium">
            <span className="flex items-center gap-2"><MapPin className="w-4 h-4 text-primary" /> {t('footer.address', '4517 Washington Ave. Manchester, Kentucky 39495')}</span>
            <span className="flex items-center gap-2" dir="ltr"><Phone className="w-4 h-4 text-primary" /> +1234 567 890</span>
            <span className="flex items-center gap-2"><Mail className="w-4 h-4 text-primary" /> hello@nouh-carting.com</span>
          </div>
